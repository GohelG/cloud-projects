...
[Project 1](../lambda-eventbridge-scheduled/README.md) — if you haven't done it, start there.
...
| Recommended first | [Project 1 — Lambda on a Schedule](../lambda-eventbridge-scheduled/README.md) |
...
- **Project 3 → [Scheduled S3 Housekeeping](../lambda-s3-housekeeping/README.md)** — apply the
