...
| Recommended first | [Lambda Basics](../lambda-basics/README.md) — handlers, roles, logs |
...
- **Project 2 → [Scheduled EC2 Start/Stop](../lambda-ec2-start-stop-scheduler/README.md)** —
  use the same schedule pattern to power EC2 instances off overnight and save money.
- **Project 3 → [Scheduled S3 Housekeeping](../lambda-s3-housekeeping/README.md)** —
