...
1. **[Scheduled Heartbeat](../../lambda-eventbridge-scheduled/README.md)** — the scheduling pattern itself
2. **[EC2 Start/Stop](../../lambda-ec2-start-stop-scheduler/README.md)** — cost savings on idle compute
3. **S3 Housekeeping** — automated storage hygiene

Keep going with **event-driven** Lambda in
[Lambda with S3 Event Processing](../../lambda-s3-event-processing/README.md), or deepen your
debugging in [Lambda Troubleshooting & Monitoring](../../lambda-troubleshooting-monitoring/README.md).
